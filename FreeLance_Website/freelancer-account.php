...
<body>
	<?php include 'header/header.php'; ?>
		<div class="main">
			...
			<form action="freelancer-welcome.php" method="post">
					<p>Create a Free Freelancer Account</p><br>
						...
						<input type="text" name="username" id="textbox" placeholder="How did you hear about 9jaWork?"><br>
						<input type="text" name="username" id="textbox" placeholder="Type the letters below"><br>
						<br><br><br><br><br><br>
